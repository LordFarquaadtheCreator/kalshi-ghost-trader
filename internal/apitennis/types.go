...
//
// API-Tennis provides a WebSocket feed that pushes point-by-point updates
// the moment they happen. The WS endpoint wss://wss.api-tennis.com/live
// pushes JSON match updates containing full point-by-point data including
// server, scorer, and break/set/match point flags.
package apitennis
