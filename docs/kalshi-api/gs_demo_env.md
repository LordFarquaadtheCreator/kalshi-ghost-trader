...
> **Warning**: The price and behavior of markets in the demo environment may not be reflective of those in real markets.
...
For the full production and demo endpoint list, see [API Environments and Endpoints](gs_api_environments.md).
