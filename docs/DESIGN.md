...
> WebSocket, storing every price/trade/lifecycle message to SQLite for
...
| [data-schema.md](data-schema.md) | Data sources (Kalshi WS, Kalshi REST, API-Tennis WS, Kalshi live-data), SQLite tables, cascade deletes, coverage classification, janitor, migrations |
...
- SQLite storage (31GB+) with WAL, single-writer, batched inserts
