...
- `api.js` — API client with caching. Methods: `getMetrics`, `getTracked`, `getOrders`, `getOrderCounts`, `getTicks`, `getStrategies`, `runBacktest`. Base URLs: `:6060` for ghost-trader, `:6061` for strategy-api.
